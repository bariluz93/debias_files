...
echo "python ${debias_files_dir}/src/cleanup.py ${collect_embedding_table} ${translate}
"
which python
...
##source /cs/usr/bareluz/gabi_labs/nematus_clean/venv/bin/activate
##python ${debias_files_dir}/src/write_results_to_table.py -m ${model}