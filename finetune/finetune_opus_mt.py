...
from translation_utilities import partially_freeze_embeddings, \
restore_model_structure
...
PROFESSION_LIST = ('accountant', 'electrician', 'surgeon', 'ceo', 'instructor', 'secretary', 'farmer', 'student',
                   ...
                   'worker', 'investigator', 'customer', 'bystander', 'pathologist', 'architect', 'guest',
                   'receptionist')
